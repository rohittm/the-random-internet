            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <p>Don't believe me? You can look for yourself by clicking that, "Discover" button. Or, if you want, you can have your money back (only, if you paid). Talking of money <span role="img" aria-labelledby="money emoji">🤑</span>, you can donate me (or, buy me a coffee, <del>here</del> [Donate page in progress] <span role="img" aria-labelledby="shy emoji">😅</span>).</p>
